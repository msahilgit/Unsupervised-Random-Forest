...
hc_random = np.load('saved_synthetic_random/hc_random.npy')
...
for h in range(2,11):
    ...
    for i in range(len(randoms)):
        ...
        clf = pkl.load( open(f'saved_synthetic_random/clf_hlabel{h}_{i}.pkl','rb') )
...
np.save('saved_lc/lc1_srandom.npy', lc1)
np.save('saved_lc/lc2_srandom.npy', lc2)
