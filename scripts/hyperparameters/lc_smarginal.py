...
hc_marginal = np.load('saved_synthetic_marginal/hc_marginal.npy')
...
for h in range(2,11):
    ...
    for i in range(len(randoms)):
        ...
        clf = pkl.load( open(f'saved_synthetic_marginal/clf_hlabel{h}_{i}.pkl','rb') )
...
np.save('saved_lc/lc1_smarginal.npy', lc1)
np.save('saved_lc/lc2_smarginal.npy', lc2)
