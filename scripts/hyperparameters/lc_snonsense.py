...
hc_nonsense = np.load('saved_synthetic_nonsense/hc_nonsense.npy')
...
for h in range(2,11):
    ...
    for i in range(len(randoms)):
        ...
        clf = pkl.load( open(f'saved_synthetic_nonsense/clf_hlabel{h}_{i}.pkl','rb') )
...
np.save('saved_lc/lc1_snonsense.npy', lc1)
np.save('saved_lc/lc2_snonsense.npy', lc2)
