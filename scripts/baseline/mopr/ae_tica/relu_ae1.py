...
for i in range(len(randoms)):
    ...
    #model
    inp = Input(shape=(229,))
    e1 = Dense(128, activation=actv, kernel_initializer=kini)(inp)
    e2 = Dense(64, activation=actv, kernel_initializer=kini)(e1)
    en = Dense(40, activation=actv, kernel_initializer=kini)(e2)
    d1 = Dense(64, activation=actv, kernel_initializer=kini)(en)
    d2 = Dense(128, activation=actv, kernel_initializer=kini)(d1)
    out = Dense(229, activation=actv, kernel_initializer=kini)(d2)
