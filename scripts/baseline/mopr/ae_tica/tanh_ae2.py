...
for i in range(len(randoms)):
    ...
    ae.save(f'saved_tanh_ae2/ae_{i}.h5')
    encoder.save(f'saved_tanh_ae2/encoder_{i}.h5')
    np.save(f'saved_tanh_ae2/loss_{i}.npy', tae.history['loss'])
    np.save(f'saved_tanh_ae2/val_loss_{i}.npy', tae.history['val_loss'])
...
np.save('saved_tanh_ae2/hists.npy', hists)
np.save('saved_tanh_ae2/extents.npy', extents)
