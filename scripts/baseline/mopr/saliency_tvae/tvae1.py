...
e4 = Dense(8, activation='relu')(e3)
e5 = Dense(4, activation='relu')(e4)

means = Dense(2, activation='relu')(e5)
stds = Dense(2, activation='relu')(e5)
...
out = Dense(229, activation='sigmoid')(d5)
