...
means = Dense(32, activation='relu')(e1)
stds = Dense(32, activation='relu')(e1)
...
for i in range(len(randoms)):
    ...
    np.save(f'saved_tvae6/rc_loss_{i}.npy', history.history['reconstruction_loss'])
    np.save(f'saved_tvae6/kl_loss_{i}.npy', history.history['kl_loss'])

    fimp = get_saliency(model, start, end)
    np.save(f'saved_tvae6/saliency_{i}.npy', fimp)
...
np.save('saved_tvae6/hists.npy', hists)
np.save('saved_tvae6/extents.npy', extents)
