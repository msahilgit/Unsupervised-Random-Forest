...
inp = Input(shape=(755,))
e1 = Dense(256, activation='relu')(inp)
e2 = Dense(128, activation='relu')(e1)
e3 = Dense(64, activation='relu')(e2)
e4 = Dense(32, activation='relu')(e3)
e5 = Dense(16, activation='relu')(e4)
e6 = Dense(8, activation='relu')(e5)
e7 = Dense(4, activation='relu')(e6)

means = Dense(2, activation='relu')(e7)
stds = Dense(2, activation='relu')(e7)
...
d7 = Dense(256, activation='relu')(d6)
out = Dense(755, activation='sigmoid')(d7)
...
for i in range(len(randoms)):
    ...
    np.save(f'saved_tvae1/rc_loss_{i}.npy', history.history['reconstruction_loss'])
    np.save(f'saved_tvae1/kl_loss_{i}.npy', history.history['kl_loss'])

    fimp = get_saliency(model, start, end)
    np.save(f'saved_tvae1/saliency_{i}.npy', fimp)
...
np.save('saved_tvae1/hists.npy', hists)
np.save('saved_tvae1/extents.npy', extents)
