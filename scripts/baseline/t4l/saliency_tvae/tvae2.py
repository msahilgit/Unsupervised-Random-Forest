...
e2 = Dense(64, activation='relu')(e1)
e3 = Dense(16, activation='relu')(e2)

means = Dense(4, activation='relu')(e3)
stds = Dense(4, activation='relu')(e3)
...
en = Input(shape=(4,))
d1 = Dense(16, activation='relu')(en)
d2 = Dense(64, activation='relu')(d1)
d3 = Dense(256, activation='relu')(d2)
out = Dense(755, activation='sigmoid')(d3)
...
for i in range(len(randoms)):
    ...
    np.save(f'saved_tvae2/rc_loss_{i}.npy', history.history['reconstruction_loss'])
    np.save(f'saved_tvae2/kl_loss_{i}.npy', history.history['kl_loss'])

    fimp = get_saliency(model, start, end)
    np.save(f'saved_tvae2/saliency_{i}.npy', fimp)
...
np.save('saved_tvae2/hists.npy', hists)
np.save('saved_tvae2/extents.npy', extents)
