...
for i in range(len(randoms)):
    ...
    np.save(f'saved_tvae3/rc_loss_{i}.npy', history.history['reconstruction_loss'])
    np.save(f'saved_tvae3/kl_loss_{i}.npy', history.history['kl_loss'])

    fimp = get_saliency(model, start, end)
    np.save(f'saved_tvae3/saliency_{i}.npy', fimp)
...
np.save('saved_tvae3/hists.npy', hists)
np.save('saved_tvae3/extents.npy', extents)
