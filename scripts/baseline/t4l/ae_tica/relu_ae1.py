...
for i in range(len(randoms)):
    ...
    ae.save(f'saved_relu_ae1/ae_{i}.h5')
    encoder.save(f'saved_relu_ae1/encoder_{i}.h5')
    np.save(f'saved_relu_ae1/loss_{i}.npy', tae.history['loss'])
    np.save(f'saved_relu_ae1/val_loss_{i}.npy', tae.history['val_loss'])
...
np.save('saved_relu_ae1/hists.npy', hists)
np.save('saved_relu_ae1/extents.npy', extents)
