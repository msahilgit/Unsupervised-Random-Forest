...
for i in range(len(randoms)):
    ...
    ae.save(f'saved_relu_ae4/ae_{i}.h5')
    encoder.save(f'saved_relu_ae4/encoder_{i}.h5')
    np.save(f'saved_relu_ae4/loss_{i}.npy', tae.history['loss'])
    np.save(f'saved_relu_ae4/val_loss_{i}.npy', tae.history['val_loss'])
...
np.save('saved_relu_ae4/hists.npy', hists)
np.save('saved_relu_ae4/extents.npy', extents)
