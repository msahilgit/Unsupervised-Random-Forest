...
for i in range(len(randoms)):
    fimp = np.load(f'saved_supervised/fimp_rfr{i}.npy')
...
np.save('saved_supervised/tlags_rfr200.npy', hists)
np.save('saved_supervised/extents_tlags_rfr200.npy', extents)
