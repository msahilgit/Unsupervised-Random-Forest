...
class synthetic_data:
    ...
    #
    EXAMPLE::
        dobj = synthetic_data(rdata, size=1, replace=False, nclasses=2)
        dobj.marginal() 
...
#         msg += line
    sahil = msg
    #
    def __init__(self, rdata, size=1, replace=False, nclasses=2):
        self.rdata = rdata
    ...
    def marginal(self, repeat=False, ignore=False):
        ...
        if repeat == False and self.size == 1 and ignore == False:
            print('Not good choice of parameters: Consider repeat=True or decrease size')
